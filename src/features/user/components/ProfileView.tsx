...
import {UserProfileData} from "@/lib/data/user"
import { Session } from "next-auth";

export type StrictSession = object & Session & {
...
export default function ProfileView({session , user } : {session: StrictSession, user: StrictUserProfile}) {
